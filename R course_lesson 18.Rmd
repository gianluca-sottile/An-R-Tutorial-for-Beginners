...
Good charts should be readable without extra documentation. Use `labs()` to add titles and axis labels. [web:631]
...
`ggsave()` saves a plot to disk; by default it saves the last displayed plot, but it is safer to pass the plot explicitly. [web:642]
