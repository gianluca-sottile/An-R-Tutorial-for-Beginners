...
The ANOVA tells you whether *any* difference exists, but not *which* pairs differ. Tukey’s HSD provides pairwise comparisons with multiple-testing adjustment. [web:566]
