---
pagetitle: "Lesson 16"
title: "Exporting Data to Excel, CSV, SAS, STATA, Text File"
editor_options:
...
The historical `xlsx` package depends on Java and `rJava`, which can be painful on Mac/Linux/CI systems.
A smoother option is `openxlsx` (no Java), using `write.xlsx()`.
