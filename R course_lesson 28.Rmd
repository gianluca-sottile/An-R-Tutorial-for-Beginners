---
pagetitle: "Lesson 28"
title: "Gradient Boosting in R (XGBoost) — Titanic Classification"
editor_options:
...
for (i in seq_len(nrow(grid))) {
  ...
  grid$best_iter[i] <- cv_i$best_iteration
  grid$best_logloss[i] <- cv_i$evaluation_log$test_logloss_mean[cv_i$best_iteration]
}

grid <- grid[order(grid$best_logloss), ]
head(grid, 10)
```
