...
A list is R’s most flexible data structure: it can store objects of **different types** in a single container (vectors, matrices, data frames, even other lists or functions). [web:807]
...
It is best practice to **name** list elements so you can extract them by name later. [web:811]
...
- `my_list[1]` returns a **sub-list** (still a list) [web:813]
- `my_list[[1]]` returns the **element itself** [web:813]
- `my_list$name` is shorthand for `my_list[["name"]]` [web:813]
