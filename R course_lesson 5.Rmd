---
pagetitle: "Lesson 5"
title: "R Data Frames: Create, Append, Select, Subset"
editor_options:
...
Note: In R ≥ 4.0 the default is effectively `stringsAsFactors = FALSE`, but it can be set explicitly for compatibility or teaching. [web:691]
...
- leaving `cols` blank means “all columns” [web:823]
...
Use a logical condition inside the row index. This style is explicit and robust. [web:823]
...
`subset()` can be convenient for quick exploration, but many workflows prefer bracket indexing for explicitness. [web:823]
